/* =====================================================================
   ...
   ---------------------------------------------------------------------
   To switch the betting panels from the verified static snapshot to
   LIVE, auto-updating market odds for ALL 38 games:

   1. Get a FREE key at  https://the-odds-api.com  (1-min signup, no card,
   ...
   silently falls back to the snapshot — it never breaks.
   ===================================================================== */
window.ODDS_API_KEY = "";
